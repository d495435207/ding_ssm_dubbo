package com.ding.biz.shiro.token.manager;
...
import com.ding.biz.shiro.token.SampleRealm;
import com.ding.biz.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	public static UUser getToken(){
		try {
			...
			throw new RuntimeException("token获取失败!不知道为啥!");
		}
	}
