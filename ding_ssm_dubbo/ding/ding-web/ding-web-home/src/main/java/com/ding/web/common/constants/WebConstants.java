package com.ding.web.common.constants;
...
public static final String CONTEXT_PATH = "contextPath";/***项目根路径*/
	...
	/**地址**/
//	public static final String DOMAIN_WWW = WebConfig.get("domain.www");//前端域名
	public static final String DOMAIN_CDN ="www.dinglh.com";// IConfig.get("domain.cdn");//静态资源域名
	public static String VERSION = String.valueOf(System.currentTimeMillis());//版本号，重启的时间
